    ...
    return (
      <CustomerLayout>
        <div style={{ padding: '100px', textAlign: 'center' }}>
          ...
          <button onClick={() => navigate('/products')} style={{ marginTop: '20px', padding: '10px 20px', background: '#3b82f6', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' }}>
            Back to Products
          </button>
        </div>
      </CustomerLayout>
      ...
      <div className="product-detail-page">
          ...
          <div className="product-images-section">
            <div className="main-image">
              <div className="image-display">
                <span style={{ fontSize: '200px' }}>{productImages[selectedImage]}</span>
              </div>
              {product.badge && (
            ...
            <div className="thumbnail-images">
              {productImages.map((img, index) => (
                ...
                >
                  <span style={{ fontSize: '40px' }}>{img}</span>
                </button>
              ))}
            </div>
          </div>
        ...
        <div className="product-description-section">
          ...
          <div className="description-content">
            ...
            <p>This premium {product.name} is designed for ultimate comfort and style. Perfect for everyday use, it combines quality materials with modern design to give you the best experience.</p>
